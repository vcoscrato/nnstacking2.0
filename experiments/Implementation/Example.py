...
if __name__ == '__main__':
    ...
    ax.set_ylabel('Y')
    ax.legend(loc=2)
    f.savefig('C:/Users/Victor/PycharmProjects/ML/NNS/Results/Example/Singles.pdf', bbox_inches='tight')
    ...
    ax.set_ylabel('Y')
    ax.legend(loc=2)
    f.savefig('C:/Users/Victor/PycharmProjects/ML/NNS/Results/Example/Stackings.pdf', bbox_inches='tight')
